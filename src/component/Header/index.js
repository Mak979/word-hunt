  ...
  return (
    <>
      <div className="w-full flex justify-center text-4xl md:text-8xl text-center text-gray-300 tracking-wider uppercase mb-4 md:mb-8">
        ...
        {phonetic && (
          <div className="w-1/12 -mt-4 md:-mt-10">
            <i
              onClick={handleBookmarkClick}
              className={`${
                localBookmark?.includes(word) ? "fas" : "far"
              } fa-bookmark cursor-pointer text-2xl md:text-4xl text-center ml-4`}
      ...
      {phonetic && (
        <div className="text-center">
          <span className="mr-4 text-xl md:text-4xl text-white">
            {phonetic}
          </span>
          <i
            className="fas fa-volume-up text-xl md:text-3xl cursor-pointer"
            onClick={handleAudio}
          ></i>
          {showAudio && (
            <audio autoPlay>
